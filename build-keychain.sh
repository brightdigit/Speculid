...
security import ./tmp/certs/developerid-key.p12 -k macos-build.keychain -P $SECURITY_PASSWORD -A
security import ./tmp/certs/developerid-cert.cer -k macos-build.keychain -A
